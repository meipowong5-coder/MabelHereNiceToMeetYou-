(function () {
    ...
    svg.selectAll("path")
        ...
        .attr("d", line)
        .attr("stroke-width", 2)
        .attr("stroke", "#add8e6")  // Lighter line color
        .attr("fill", "#add8e6")  // Lighter fill color
    ...
    // Category color scale for points - Lighter user-defined colors (pastel blue, purple, pink)
    const categoryColor = d3.scaleOrdinal()
        .domain(["Personal Qualities", "Social Skills", "Professional Skills"])
        .range(["#b3cde0", "#cbbedd", "#edccdb"]);
    ...
    const legendData = [
        { color: "#b3cde0", label: "Personal Qualities" },
        { color: "#cbbedd", label: "Social Skills" },
        { color: "#edccdb", label: "Professional Skills" }
    ];
